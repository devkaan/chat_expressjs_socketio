        ...
        function (e, t, r) {
          ...
          function f(e, t, r) {
            if (e) {
              ...
              for (
                var c = 0;
                0 < r.depth && null !== (i = n.exec(o)) && c < r.depth;
        ...
        function (e, t, r) {
          ...
          function j(e, t, r, o, n, i, a, l, c, s, f, u, p) {
            ...
            if (
              ...
              return i
                ? [
                    f(u ? t : i(t, N.encoder, p, "key")) +
                      "=" +
                      f(i(y, N.encoder, p, "value")),
                  ]
                : [f(t) + "=" + f(String(y))];
            var m,
              h = [];
            ...
            var r,
              ...
              n = (function (e) {
                ...
                var o = p.formatters[r],
                  n = N.filter;
                return (
                  ("function" != typeof e.filter && !x(e.filter)) ||
                    (n = e.filter),
                  {
                    addQueryPrefix:
                      "boolean" == typeof e.addQueryPrefix
                        ...
                        : N.addQueryPrefix,
                    allowDots:
                      void 0 === e.allowDots ? N.allowDots : !!e.allowDots,
                    charset: t,
                    charsetSentinel:
                      "boolean" == typeof e.charsetSentinel
                        ? e.charsetSentinel
                        : N.charsetSentinel,
                    delimiter:
                      void 0 === e.delimiter ? N.delimiter : e.delimiter,
                    encode: "boolean" == typeof e.encode ? e.encode : N.encode,
                    encoder:
                      "function" == typeof e.encoder ? e.encoder : N.encoder,
                    encodeValuesOnly:
